...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/wordlehelper',
        'Source': 'https://github.com/apiverve/wordlehelper-api',
        'Bug Tracker': 'https://github.com/apiverve/wordlehelper-api/issues'
    },
    classifiers=[
