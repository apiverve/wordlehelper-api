...
class WordlehelperAPIClient:
    ...
    VALIDATION_RULES = {"green": {"type": "string", "required": False}, "yellow": {"type": "string", "required": False}, "gray": {"type": "string", "required": False}, "pattern": {"type": "string", "required": False, "minLength": 5, "maxLength": 5}, "limit": {"type": "integer", "required": False, "min": 1, "max": 100, "default": 25}}
