...
namespace APIVerve.API.WordleHelper
{
    ...
    /// <summary>
    /// Client for the WordleHelper API
    /// </summary>
    public class WordleHelperAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/wordlehelper";
        ...
        {
            { "green", new ValidationRule { Type = "string", Required = false } },
            { "yellow", new ValidationRule { Type = "string", Required = false } },
            { "gray", new ValidationRule { Type = "string", Required = false } },
            { "pattern", new ValidationRule { Type = "string", Required = false, MinLength = 5, MaxLength = 5 } },
        ...
        public WordleHelperAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordleHelperAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordleHelperAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WordleHelperQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WordleHelperQueryOptions options)
        {
        ...
        public ResponseObj Execute(WordleHelperQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WordleHelperQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WordleHelperQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WordleHelperQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WordleHelperQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WordleHelperQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WordleHelperQueryOptions options)
        {
