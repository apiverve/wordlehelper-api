...
class wordlehelperWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/wordlehelper');
        }
        ...
        this.validationRules = {"green":{"type":"string","required":false},"yellow":{"type":"string","required":false},"gray":{"type":"string","required":false},"pattern":{"type":"string","required":false,"minLength":5,"maxLength":5},"limit":{"type":"integer","required":false,"min":1,"max":100,"default":25}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/wordlehelper`);
        }
    }
...
module.exports = wordlehelperWrapper;
