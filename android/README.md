...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordlehelper-api:1.1.14'
}
```
...
```java
import com.apiverve.wordlehelper.WordleHelperAPIClient;
import com.apiverve.wordlehelper.APIResponse;
import com.apiverve.wordlehelper.APIException;

// Initialize the client
WordleHelperAPIClient client = new WordleHelperAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordlehelper](https://docs.apiverve.com/ref/wordlehelper)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordlehelper](https://docs.apiverve.com/ref/wordlehelper)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordlehelper-api/issues)
